...
![](images/custom-api-preview-4.png)
...
> [!NOTE]
>
> For current GitHub notifications to work, you need to create a [personal access token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) with the `notifications` scope and set it as the `GITHUB_TOKEN` environment variable.
> 
